...
public class ByzantineTestPuppetMaster{
    public static void main(String[] args) throws Exception {
        ...
        String commandByzantine = "java ByzantineServer";
        ...
        String[] terminalCommand4 = {"cmd.exe", "/c", "start", "cmd.exe", "/k",commandByzantine+" 4 "+ports[3]+portsS+clients};
